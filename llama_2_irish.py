...
prompt = PromptTemplate(
    ...
    template="""
    Answer the following using the following text in the context of Ireland\n\n
    Question: {question}\n\n
    Answer:  """
)
...
for i, j  in zip(texts_train,questions_train):
    ...
    summary = llm_chain.predict(question = j).lstrip()
    print(summary)
...
df_train.to_csv('irish_llama_7b_instruct_12000.csv')
